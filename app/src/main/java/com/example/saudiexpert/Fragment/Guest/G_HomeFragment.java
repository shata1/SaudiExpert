...
import com.example.saudiexpert.Activity.Guest.G_TourDetailsActivity;
...
import com.example.saudiexpert.databinding.FragmentGHomeBinding;
...
public class G_HomeFragment extends Fragment implements TourAdapter.OnItemClickListener {
    FragmentGHomeBinding homeBinding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        homeBinding = FragmentGHomeBinding.inflate(inflater, container, false);
    ...
    public void onItem_Click(int position) {
        ...
        startActivity(new Intent(getActivity(), G_TourDetailsActivity.class).putExtra("TourObject", tour));
    }
}