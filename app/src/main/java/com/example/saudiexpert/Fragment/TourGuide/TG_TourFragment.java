...
import com.example.saudiexpert.Adapter.CartAdapter;
import com.example.saudiexpert.Model.TourBook;
import com.example.saudiexpert.databinding.FragmentTgTourBinding;
...
public class TG_TourFragment extends Fragment {

    FragmentTgTourBinding tourBinding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tourBinding = FragmentTgTourBinding.inflate(inflater, container, false);
    ...
    private void init() {
        ...
        adapter = new CartAdapter(getContext(), tourBooks);
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                            ...
                            if (tourBook != null) {
                                if (tourBook.getTourGuideKey().equals(user.getUid())) {
