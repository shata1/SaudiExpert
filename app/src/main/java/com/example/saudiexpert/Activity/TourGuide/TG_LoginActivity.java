...
import com.example.saudiexpert.databinding.ActivityTgLoginBinding;
...
public class TG_LoginActivity extends AppCompatActivity {
    ...
    void reviewInputData() {
        ...
        TourGuideLogin(inputEmail, inputPassword);
    }

    void TourGuideLogin(String Email, String Password) {
        firebaseAuth.signInWithEmailAndPassword(Email, Password)
                .addOnCompleteListener(task -> {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        startActivity(new Intent(TG_LoginActivity.this, TG_HomeActivity.class));
